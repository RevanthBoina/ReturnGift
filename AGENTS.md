...
- **Visual grounding preference** (observation finding): Rule 2 + LOCAL_TASK_PROMPT prefer tap(x,y) bounding-box centers; tap_node semantic selectors are the fallback. SemanticTargetResolver code is untouched.
