...
object TaskPromptEnvelope {
    ...
    private const val HISTORY_START = "<<<RETURNGIFT_CHAT_HISTORY>>>"
    private const val HISTORY_END = "<<<END_RETURNGIFT_CHAT_HISTORY>>>"
    private const val BACKGROUND_START = "<<<RETURNGIFT_BACKGROUND_STATE>>>"
    private const val BACKGROUND_END = "<<<END_RETURNGIFT_BACKGROUND_STATE>>>"
    private const val REQUEST_START = "<<<RETURNGIFT_CURRENT_REQUEST>>>"
    private const val REQUEST_END = "<<<END_RETURNGIFT_CURRENT_REQUEST>>>"
