    ...
    private fun takeScreenshot(context: Context): String {
        return try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ...
                val svc = com.returngift.agent.service.ClawAccessibilityService.getInstance()
                if (svc != null) {
                    ...
                    "Screenshot requires Accessibility permission. Please enable ReturnGift in Accessibility settings."
                }
            } else {
    ...
    private fun pressBack(context: Context): String {
        return try {
            ...
            if (svc != null) {
                ...
                "Back shortcut requires Accessibility permission. Please enable ReturnGift in Accessibility settings."
            }
        } catch (e: Exception) {
