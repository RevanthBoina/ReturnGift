 ...
 *
 * Requires: Settings → Notification Access → ReturnGift enabled.
 */
public class ClawNotificationListener extends NotificationListenerService {
    ...
    private void maybeReturnToAppAfterPermissionFlow() {
        ...
        mainHandler.postDelayed(() -> {
            try {
                android.content.Intent intent = new android.content.Intent(this, com.returngift.agent.ui.settings.SettingsActivity.class);
