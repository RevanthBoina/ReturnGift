...
abstract class BaseTool {
    ...
    fun getParametersWithWaitAfter(): List<ToolParameter> {
        ...
        if (getName() !in listOf("wait", "finish", "get_screen_info", "take_screenshot", "get_installed_apps", "scroll_to_find", "get_foreground_app", "list_scheduled_tasks", "schedule_task", "cancel_scheduled_task")) {
