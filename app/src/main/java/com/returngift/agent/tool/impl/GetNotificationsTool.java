...
import com.returngift.agent.service.ClawNotificationListener;
    ...
    public ToolResult execute(Map<String, Object> params) {
        ...
        try {
            ...
            for (StatusBarNotification sbn : notifications) {
                // Skip ReturnGift's own notifications
                if ("com.returngift.agent".equals(sbn.getPackageName())) continue;
            ...
            if (count == 0) {
                return ToolResult.success("No active notifications (only ReturnGift system notifications present).");
            }
