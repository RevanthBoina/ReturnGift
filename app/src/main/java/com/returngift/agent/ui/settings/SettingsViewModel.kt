...
import com.returngift.agent.agent.llm.ActiveModelMode
...
import com.returngift.agent.widget.QRCodeDialog
...
class SettingsViewModel : ViewModel() {
    ...
    fun startWeChatQrLogin(context: Context) {
        viewModelScope.launch {
            val loadingDialog = com.returngift.agent.widget.LoadingDialog.show(
                context = context,
                message = context.getString(R.string.channel_config_wechat_scanning)
            )
            try {
                val apiClient = com.returngift.agent.channel.wechat.WeChatApiClient()
    ...
    private fun startWeChatQrPolling(
        context: Context,
        dialog: QRCodeDialog,
        apiClient: com.returngift.agent.channel.wechat.WeChatApiClient,
        qrcode: String
    ): Job {
    ...
    fun unbindWeChat() {
        ...
        com.returngift.agent.channel.wechat.WeChatInbound.clearContextTokensForAccount(accountId)
