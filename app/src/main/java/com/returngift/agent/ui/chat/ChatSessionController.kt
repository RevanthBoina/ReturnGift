...
import com.returngift.agent.agent.llm.LlmSessionManager
import com.returngift.agent.agent.llm.LocalModelManager
import com.returngift.agent.agent.llm.LocalModelRuntime
...
class ChatSessionController(
    ...
    private fun buildConversationConfig(systemPrompt: String? = null): ConversationConfig {
        val finalPrompt = com.returngift.agent.agent.PromptUtils
